...
if (isMobile && !isMobile_mobile){
    const observer_for_who = new IntersectionObserver(entries => {
        ...
        {
            document.getElementById('for_who__item_left').classList.add('for_who__item_left_animation');
            document.getElementById('for_who__item_right').classList.add("for_who__item_center_animation");
            document.getElementById('for_who__item_center').classList.add("for_who__item_right_animation");
            observer_for_who.disconnect();
        }
    }, {
        rootMargin: '-200px' 
...
if (isMobile_mobile){
    const observer_for_who = new IntersectionObserver(entries => {
        ...
        {
            document.getElementById('for_who__item_left').classList.add('for_who__item_left_animation');
            document.getElementById('for_who__item_right').classList.add("for_who__item_left_animation");
            document.getElementById('for_who__item_center').classList.add("for_who__item_right_animation");
            observer_for_who.disconnect();
        }
    }, {
