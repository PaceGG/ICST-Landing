# Документация к HTML блоку "header"
...
Блок с изображениями. По умолчанию, видимо, отображается только первое изображение (`display: block`), остальные скрыты (`display: none`).
...
# Документация к блоку "advantages"
